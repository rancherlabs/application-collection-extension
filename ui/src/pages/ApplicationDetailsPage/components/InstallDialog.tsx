import { Accordion, AccordionDetails, AccordionSummary, Button, IconButton, Skeleton, Stack, TextField, Tooltip, Typography } from '@mui/material'
...
{ branch: string, artifact: ArtifactListItemReducedDTO | ArtifactDTO, version: string, isOpen: boolean, onSubmit?: () => any, onDismiss?: () => any }) {
  ...
  const [ state, setState ] = useState<'ready' | 'loading-local-values' | 'installing'>()
