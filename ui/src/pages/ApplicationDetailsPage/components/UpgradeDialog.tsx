...
export default function UpgradeDialog({ artifact, workload, isOpen, onDismiss = () => null }: 
{ artifact: ArtifactListItemReducedDTO, workload: HelmListItem, isOpen: boolean, onDismiss?: () => any }) {
