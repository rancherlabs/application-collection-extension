...
import { ApplicationDTOTypeEnum, ArtifactListItemReducedDTOPackagingFormatEnum, BranchDTO } from '../../../../../autogenerated/client/backend'
import { sortArtifacts } from '../../../../clients/util'
import BranchCard from './BranchCard'


export default function BranchesList({ branches, applicationType, disabled = false }: { branches: BranchDTO[], applicationType?: ApplicationDTOTypeEnum, disabled?: boolean }) {
  if (!applicationType) {
    return <Typography>This application cannot be deployed yet</Typography>
  }

  const packagingFormat = applicationType === ApplicationDTOTypeEnum.HelmChart
    ? ArtifactListItemReducedDTOPackagingFormatEnum.HelmChart
    : ArtifactListItemReducedDTOPackagingFormatEnum.Container
