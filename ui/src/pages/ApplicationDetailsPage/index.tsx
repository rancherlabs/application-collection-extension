...
import { ApplicationDTO, ApplicationDTOTypeEnum, ComponentDTO } from '../../../autogenerated/client/backend'
...
export default function ApplicationDetailsPage() {
  ...
  function humanFriendlyType(type?: ApplicationDTOTypeEnum) {
    if (type === ApplicationDTOTypeEnum.HelmChart) return 'Helm chart'
    if (type === ApplicationDTOTypeEnum.SingleContainer) return 'Single container'
    return 'Coming soon'
  }
    ...
    <>
      <Stack direction='row' spacing={ 2 } alignItems='center'>
        ...
        <Stack direction='column' alignItems='start'>
          ...
          <Chip label={ humanFriendlyType(application.type) } size='small' color='primary' />
        </Stack>
      </Stack>
      ...
      <Typography variant='h5' sx={ { mb: 3 } }>Run new workloads in your cluster</Typography>
      <BranchesList 
        branches={ component.branches.filter(b => !b.inactive_at || new Date(b.inactive_at) > new Date()) } applicationType={ application.type }
        disabled={ !auth } />
    </>
  )
}