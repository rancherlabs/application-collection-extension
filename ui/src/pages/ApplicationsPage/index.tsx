...
export default function ApplicationsPage() {
  ...
  useEffect(() => {
    applicationsClient(auth || null).getApplications(undefined, undefined, ApplicationReducedViewDTOTypeEnum.HelmChart)
      .then(response => {
  ...
  function loadAppsPage() {
    applicationsClient(auth || null).getApplications(undefined, undefined, ApplicationReducedViewDTOTypeEnum.HelmChart, undefined, nextPage)
      .then((response) => {
